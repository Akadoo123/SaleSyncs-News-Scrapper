@echo off
REM ============================================================
REM  SaleSync Daily AI & SaaS Intelligence - ตัวเรียกใช้สำหรับ Task Scheduler
REM
REM  มีไฟล์นี้เพื่อเลี่ยงปัญหาการใส่เครื่องหมายคำพูดซ้อนกันใน
REM  powershell.exe -Command "..." ซึ่งพังทันทีเมื่อพาธมีช่องว่าง
REM  (โฟลเดอร์โปรเจกต์ชื่อ "AI Saas News Scrap" มีช่องว่างอยู่)
REM
...
REM ใช้ UTF-8 เพื่อให้ข้อความไทย (echo + stdout ของ Node) ลง log ได้ถูกต้อง
chcp 65001 >nul

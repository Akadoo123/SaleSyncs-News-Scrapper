<#
.SYNOPSIS
    ตั้ง Windows Task Scheduler ให้รัน SaleSync Daily Intelligence ทุกวัน 08:00 น.
...
param(
    ...
    [switch]$Status,
    [switch]$Elevated,
    [string]$TaskName = 'SaleSyncDailyIntelligence',
    [string]$Time = '08:00'
)
...
if ($Install) {
    ...
    $register = @{
        ...
        Trigger     = $trigger
        Settings    = $settings
        Description = 'SaleSync Daily AI & SaaS Market Intelligence - ดึงและวิเคราะห์ข่าวประจำวัน'
    }
    if ($Elevated) {

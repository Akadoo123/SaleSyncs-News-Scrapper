...
describe('i18n — คีย์ที่โค้ดเรียกใช้ต้องมีอยู่จริง', () => {
  ...
  it('คีย์ที่ประกอบขึ้นตอนรัน (verdict/cat/prod/okr/…) ต้องครบทุกค่า', () => {
    const groups: Record<string, string[]> = {
      ...
      cat: ['AI_TECH', 'SAAS_CLOUD', 'CRM_SALESTECH', 'DATA_REGULATION', 'COMPETITOR', 'PLATFORM', 'THAI_DIGITAL', 'FUNDING_MACRO', 'INTERNATIONAL', 'OTHER'],
      prod: ['CRM_CORE', 'AI_ENGINE', 'INCENTIVE'],
    };

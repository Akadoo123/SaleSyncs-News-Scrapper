...
(function (root) {
  ...
  var DICT = {
    th: {
      'brand.sub': 'ข่าวกรอง AI / SaaS / CRM ประจำวัน · SaleSync',
      'doc.title': 'SaleSync — ข่าวกรองตลาด AI & SaaS ประจำวัน',
      ...
      'kpi.ev': 'ข่าว AI',
      'kpi.evFoot': 'เทคโนโลยีหลัก',
      'kpi.intl': 'ข่าวต่างประเทศ',
      'kpi.intlFoot': 'ตลาด/สัญญาณต่างประเทศ',
      'kpi.b2b': 'โอกาส SaaS',
      'kpi.b2bFoot': 'ลูกค้า SaaS ภายนอก',
      'kpi.o2': 'สัญญาณหนุน O2',
      'kpi.o2Foot': 'ขยายเป็น SaaS ภายนอก',
      'kpi.social': 'เสียงจากโซเชียล',
      'kpi.socialFoot': 'Pantip / โซเชียล — ยังไม่ยืนยัน',
      'kpi.signal': 'สัญญาณเสริม',
      'kpi.signalFoot': 'ปิดใช้งานในโหมด SaaS',
      ...
      'card.why': 'ทำไมจึงเกี่ยวข้องกับ SaleSync',
      ...
      'cat.AI_TECH': 'AI / เทคโนโลยี',
      'cat.SAAS_CLOUD': 'SaaS / คลาวด์',
      'cat.CRM_SALESTECH': 'CRM / Sales-tech',
      'cat.DATA_REGULATION': 'กฎเกณฑ์ข้อมูล/AI',
      'cat.COMPETITOR': 'คู่แข่ง',
      'cat.PLATFORM': 'แพลตฟอร์มใหญ่',
      'cat.THAI_DIGITAL': 'ดิจิทัลไทย / SME',
      'cat.FUNDING_MACRO': 'ทุน / เศรษฐกิจ',
      'cat.INTERNATIONAL': 'ต่างประเทศ',
      'cat.OTHER': 'อื่น ๆ',
      'prod.CRM_CORE': 'แพลตฟอร์ม CRM',
      'prod.AI_ENGINE': 'AI Engine',
      'prod.INCENTIVE': 'Incentive Tracking',
      'prodFilter.CRM_CORE': 'แพลตฟอร์ม CRM (Customer 360)',
      'prodFilter.AI_ENGINE': 'AI Engine (พยากรณ์ / Next Best Action)',
      'prodFilter.INCENTIVE': 'Frontline Incentive',
      ...
      'okrBox.O1': 'O1 — พิสูจน์ผล & เพิ่มรายได้ Air4',
      'okrBox.O2': 'O2 — ขยายเป็น vertical SaaS ภายนอก',
      ...
      'drawer.o1': 'O1 — พิสูจน์ผลใน Air4',
      'drawer.o2': 'O2 — ขยาย SaaS ภายนอก',
      'sys.failed': 'ล้มเหลว',
    ...
    en: {
      'brand.sub': 'Daily AI / SaaS / CRM market intelligence · SaleSync',
      'doc.title': 'SaleSync — Daily AI & SaaS Market Intelligence',
      ...
      'kpi.ev': 'AI news',
      'kpi.evFoot': 'Core technology',
      'kpi.intl': 'International',
      'kpi.intlFoot': 'Overseas markets / signals',
      'kpi.b2b': 'SaaS opportunities',
      'kpi.b2bFoot': 'External SaaS customers',
      'kpi.o2': 'O2 supporting',
      'kpi.o2Foot': 'Scale as external SaaS',
      'kpi.social': 'Social mentions',
      'kpi.socialFoot': 'Pantip / social — unverified',
      'kpi.signal': 'Extra signals',
      'kpi.signalFoot': 'Disabled in SaaS mode',
      ...
      'card.why': 'Why this matters to SaleSync',
      ...
      'cat.AI_TECH': 'AI / technology',
      'cat.SAAS_CLOUD': 'SaaS / cloud',
      'cat.CRM_SALESTECH': 'CRM / sales-tech',
      'cat.DATA_REGULATION': 'Data / AI regulation',
      'cat.COMPETITOR': 'Competitors',
      'cat.PLATFORM': 'Big platforms',
      'cat.THAI_DIGITAL': 'Thai digital / SME',
      'cat.FUNDING_MACRO': 'Funding / economy',
      'cat.INTERNATIONAL': 'International',
      'cat.OTHER': 'Other',
      'prod.CRM_CORE': 'CRM platform',
      'prod.AI_ENGINE': 'AI Engine',
      'prod.INCENTIVE': 'Incentive tracking',
      'prodFilter.CRM_CORE': 'CRM platform (Customer 360)',
      'prodFilter.AI_ENGINE': 'AI Engine (prediction / Next Best Action)',
      'prodFilter.INCENTIVE': 'Frontline incentive',
      ...
      'okrBox.O1': 'O1 — prove & lift Air4 revenue',
      'okrBox.O2': 'O2 — scale as external vertical SaaS',
      ...
      'drawer.o1': 'O1 — prove inside Air4',
      'drawer.o2': 'O2 — external SaaS scale',
      'sys.failed': 'failed',
